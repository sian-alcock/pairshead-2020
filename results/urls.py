...
path('original-event-import-folder/', original_event_category.ImportOriginalEventCategoryCSVFolder.as_view()),
path('event-order-import/', event_order.EventOrderImport.as_view()),
path('event-order-import-folder/', event_order.ImportEventOrderCSVFolder.as_view()),
path('marshalling-division-import-folder/', marshalling_division.ImportMarshallingDivisionCSVFolder.as_view()),
path('number-location-import-folder/', number_location.ImportNumberLocationCSVFolder.as_view()),
