...
export default function RaceInfoNew () {
...
//     data,
//     loading
//   } = useFetchData(`/api/global-settings-list`)
          ...
          <form onSubmit={handleSubmit} className="race-info__form">
            ...
            <div className="field">
              ...
              <input
                ...
                id="offsetHours"
                value={formData.timing_offset_hours || ''}
            ...
            <div className="field">
              ...
              <input
                ...
                min="0"
                max="59"
                value={formData.timing_offset_minutes || ''}
                onChange={handleChange} />
            </div>
            ...
            <div className="field">
              ...
              <input
                ...
                min="0"
                max="59"
                value={formData.timing_offset_seconds || ''}
                onChange={handleChange} />
            </div>
            ...
            <div className="field">
              ...
              <input
                ...
                min="0"
                max="99"
                value={formData.timing_offset_hundredths_seconds || ''}
                onChange={handleChange} />
            </div>
